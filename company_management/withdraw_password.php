...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini main">
           ...
           <div class="main">
                ...
                <div class="managerinfo_confirm">
                	<div class="title">
    	            	...
    	            	<p>비밀번호 확인</p>
        	        	<span>기업 이용해지 진행을 위해 다시 한번 비밀번호를 입력해주세요.</span>
        	        </div>
                	<div class="content">
                		<input type="text" placeholder="mustknow_022"/>
                		<input type="text" placeholder="비밀번호를 입력해주세요."/>
                	</div>
            		  <div class="action-rm action-rm-ly">
                     <!-- <a href="#" class="memory" data-toggle="modal" style="width:99px">수정</a> -->
                      <a href="#" class="btn-confirm" data-toggle="modal" data-target="#re_password" style="width:154px">확인</a>
          		    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Modal 비밀번호를 다시 입력해주세요.-->
    <div class="modal fade" id="re_password" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
      <div class="modal-dialog modal-sm" style="width:371px;">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="myModalLabel">비밀번호를 다시 입력해주세요.</h4>
          </div>
          <div class="modal-body">
            비밀번호가 잘못 입력되었습니다.<br>다시 정확하게 입력해주세요
          </div>
          <div class="modal-footer" style="text-align:center">
            <!-- <button type="button" class="btn btn-black" data-dismiss="modal">취소</button> -->
            <button type="button" class="btn btn-confirm" data-toggle="modal" data-target="#confirm_num">확인</button>
          </div>
        </div>
      </div>
    </div>
